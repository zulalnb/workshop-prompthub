    ...
    <section className="w-full max-w-full flex-start flex-col">
      ...
      >
        ...
        <div className="flex-end mx-3 mb-5 gap-4">
          <Link
            className="px-5 py-2 rounded-2xl text-white font-semibold bg-gray-500 hover:bg-gray-600"
            href="/"
          >
            Cancel
          </Link>
          <button
            ...
            className="px-5 py-2 rounded-2xl text-white font-semibold bg-blue-500 hover:bg-blue-600"
          >
